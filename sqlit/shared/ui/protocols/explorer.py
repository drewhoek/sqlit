...
class ExplorerActionsProtocol(Protocol):
    ...
    def _count_snapshot_nodes(self, snapshot: list[Any]) -> int: ...

    def _match_label(self, label_text: str) -> tuple[bool, list[int]]: ...

    def _filter_snapshot(self, snap: Any) -> Any | None: ...

    def _materialize_filtered(self, parent: Any, entry: Any, matches: list[Any], style: str) -> None: ...

    def _highlight_label(self, displayed: str, label_text: str, indices: list[int], style: str) -> str: ...

    def _move_cursor_to(self, node: Any) -> None: ...
